        ...
        >
          ...
          <div className="relative z-10">
            ...
            <div className="font-mono">
              ...
              <motion.a
                href="mailto:an.lethanhduy@outlook.com.vn"
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                {/* Github */}
                <motion.a
                  href="https://github.com/Anlele1701"
                  target="_blank"
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-400">@Anlele1701</p>
                  </div>
                </motion.a>
                {/* LinkedIn */}
                <motion.a
                  href="https://www.linkedin.com/in/an-lethanhduy/"
                  target="_blank"
                  whileHover={{ scale: 1.05 }}
                  className="flex items-center gap-3 px-4 py-3 bg-gray-800/50 rounded-lg hover:bg-gray-700/50 transition-colors border border-gray-700/50 group"
                >
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-400">An Le</p>
                  </div>
                </motion.a>
                {/* Phone number */}
                <motion.a
                ...
                >
                  <div className="p-2 bg-gray-700/50 rounded-lg group-hover:bg-gray-600/50 transition-colors">
                    <svg
                      ...
                      viewBox="0 0 24 24"
                    >
                      <path d="M3 2.5a1 1 0 011-1h4a1 1 0 011 1v2a1 1 0 01-.3.7l-1.6 1.6a12.8 12.8 0 006.4 6.4l1.6-1.6a1 1 0 01.7-.3h2a1 1 0 011 1v4a1 1 0 01-1 1A17 17 0 013 3.5v-1z" />
                    </svg>
                  </div>
                  <div>
                    <p className="font-semibold text-gray-200">Mobile phone</p>
                    <p className="text-sm text-gray-400">0702176453</p>
                  </div>
                </motion.a>
              </div>
            </div>
